...
[🚀 Демо](#запуск-проекта) • [📖 Документация](#документация-api) • [🧪 Тесты](backend/tests)
...
**Omni Player** — веб-приложение для организации совместного прослушивания музыки. Создавайте комнаты, приглашайте друзей, управляйте общей очередью треков и наслаждайтесь синхронным воспроизведением с встроенным чатом.
